...
const EducationCard = ({ description, uni, date, degree }) => {
    return (
        <div className=' border-l px-8  mb-10 relative'>
            <div className=' text-primary-dark dark:text-primary-light font-semibold bg-gray-100 dark:bg-primary-dark px-2 rounded-2xl w-fit text-sm mb-5'>{date}</div>
            <div className=' sm:flex  items-center mb-3'>
                <div className=' font-semibold text-lg text-primary-dark dark:text-primary-light mr-2'>{degree.toUpperCase()}</div>
                <div className='hidden sm:block w-6 bg-primary-dark dark:bg-primary-light h-[2px]'></div>
                <div className=' ml-3 font-semibold text-gray-500 dark:text-primary-light'>{uni.toUpperCase()}</div>
