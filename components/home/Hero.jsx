    ...
    <>
      <AnimateLayout>
        <div className="background-dark">
          <div className="relative animation lg:h-screen lg:overflow-hidden lg:overflow-y-scroll w-full sm:w-[500px] md:w-[700px] mx-auto lg:w-full">
            <div className="relative w-full pt-20 pb-32 lg:py-10 w-padding h-full flex lg:flex-row flex-col gap-10 lg:gap-5 xl:gap-24 items-center">
              ...
              <div className="flex w-full max-w items-center justify-center">
                <div className="flex w-full lg:w-[500px] xl:w-[700px]  justify-center items-center lg:items-start lg:justify-start flex-col gap-5">
                  <div className="font-bold flex flex-col items-center lg:items-start  uppercase font-Poppins tracking-wide text-xl sm:text-3xl leading-[30px] md:leading-[52px] md:text-[42px] ">
